    ...
    Ok(ChainSpec::from_genesis(
        ...
        move || {
            testnet_genesis(
                ...
                vec![(get_aura_id_from_adrs(SUDO_T1RN), get_grandpa_id_from_adrs(SUDO_T1RN))],
                // Sudo account
                hex_literal::hex!("5ecd4d9f0255ed3d3c5ac1160a965f0ea743b74533036f1e4d3f4bfc43f9f061").into(),
                // Pre-funded accounts
                vec![
                    hex_literal::hex!("5ecd4d9f0255ed3d3c5ac1160a965f0ea743b74533036f1e4d3f4bfc43f9f061").into(),
                ],
