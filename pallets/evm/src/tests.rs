...
fn fee_deduction() {
    new_test_ext().execute_with(|| {
		...
		let imbalance = <<Test as Config>::OnChargeTransaction as OnChargeEVMTransaction<Test>>::withdraw_fee(&evm_addr, U256::from(convert_decimals_to_evm::<u64>(10u64))).unwrap();
