mod threevm_mock {
    ...
    impl pallet_circuit::Config for Test {
        type AccountManager = AccountManager;
        type Attesters = t3rn_primitives::attesters::AttestersReadApiEmptyMock<
            AccountId32,
            Balance,
            DispatchError,
        >;
    ...
    impl TreasuryAccountProvider<AccountId32> for Test {
        fn get_treasury_account(_treasury_account: TreasuryAccount) -> AccountId32 {
    ...
    impl pallet_xdns::Config for Test {
        ...
        type AttestersRead = t3rn_primitives::attesters::AttestersReadApiEmptyMock<
            AccountId32,
            Balance,
            DispatchError,
        >;
