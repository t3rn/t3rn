...
#[derive(Clone, Encode, Decode, scale_info::TypeInfo, Default)]
...
mod tests {
    ...
    impl Ext for MockExt {
        ...
        fn get_weight_price(&self, weight: Weight) -> BalanceOf<Self::T> {
            BalanceOf::<Self::T>::from(1312_u32).saturating_mul(weight)
        }
