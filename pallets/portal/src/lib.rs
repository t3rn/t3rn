...
impl<T: Config> Portal<T> for Pallet<T> {
    ...
    fn verify_state_inclusion_and_recode(
        ...
        let encoded_ingress = <Pallet<T> as Portal<T>>::verify_state_inclusion(
            gateway_id,
            message,
            submission_target_height,
        )?;
    ...
    fn verify_tx_inclusion_and_recode(
        ...
        let encoded_ingress = <Pallet<T> as Portal<T>>::verify_tx_inclusion(
            gateway_id,
            message,
            submission_target_height,
        )?;
    ...
    fn verify_event_inclusion_and_recode(
        ...
        let encoded_ingress = <Pallet<T> as Portal<T>>::verify_event_inclusion(
            gateway_id,
            message,
            submission_target_height,
        )?;
