...
use pallet_3vm_evm::{AddressMapping, EnsureAddressNever, EnsureAddressRoot, EnsureAddressTruncated, FeeCalculator, IdentityAddressMapping, SubstrateBlockHashMapping};
use rlp::RlpStream;
...
//use circuit_runtime_pallets::evm_precomile_util;
...
frame_support::construct_runtime! {
	pub enum Test {
		...
		EVM: pallet_3vm_evm::{Pallet, Call, Storage, Config<T>, Event<T>},
...
impl pallet_3vm_evm::Config for Test {
    type AddressMapping = HashedAddressMapping;
    type BlockGasLimit = BlockGasLimit;
    type BlockHashMapping = pallet_3vm_evm::SubstrateBlockHashMapping<Self>;
    ...
    type GasWeightMapping = pallet_3vm_evm::FixedGasWeightMapping<Test>;
