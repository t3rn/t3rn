...
mod tests {
	...
	#[test]
	fn encode_string() {
		let s = Token::String("gavofyork".into());
	...
	fn encode_dynamic_tuple() {
		let string1 = Token::String("gavofyork".into());
		let string2 = Token::String("gavofyork".into());
	...
	fn encode_nested_tuple() {
		let string1 = Token::String("test".into());
		let string2 = Token::String("cyborg".into());
		let string3 = Token::String("night".into());
		let string4 = Token::String("day".into());
		let string5 = Token::String("weee".into());
		let string6 = Token::String("funtests".into());
	...
	fn encode_params_containing_dynamic_tuple() {
		...
		let string1 = Token::String("spaceship".into());
		let string2 = Token::String("cyborg".into());
