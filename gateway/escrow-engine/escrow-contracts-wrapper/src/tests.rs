...
use crate::{
    gas::Gas, BalanceOf, Config, ContractAddressFor, ContractInfo, ContractInfoOf, Error,
    GenesisConfig, Module, RawAliveContractInfo, RawEvent, RuntimeReturnCode, Schedule, Trait,
...
pub mod test_utils {
    ...
    use crate::storage::{read_contract_storage, write_contract_storage};
    use crate::{CodeHash, ContractInfoOf, TrieIdGenerator};
...
fn removals(trigger_call: impl Fn() -> bool) {
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_eq!(Balances::free_balance(BOB), 50 + subsistence_threshold,);
...
fn transfer_return_code() {
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            let result = Contracts::bare_call(ALICE, BOB, 0, GAS_LIMIT, vec![])
                .0
                .unwrap();
...
fn call_return_code() {
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            let result = Contracts::bare_call(ALICE, BOB, 0, GAS_LIMIT, vec![0])
                .0
                .unwrap();
            ...
            let result = Contracts::bare_call(ALICE, BOB, 0, GAS_LIMIT, vec![1])
                .0
                .unwrap();
            assert_return_code!(result, RuntimeReturnCode::CalleeReverted);

            // Contract has enough balance but callee traps because "2" is passed.
            let result = Contracts::bare_call(ALICE, BOB, 0, GAS_LIMIT, vec![2])
                .0
                .unwrap();
...
fn instantiate_return_code() {
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            // Contract has only the minimal balance so any transfer will return BelowSubsistence.
            let result = Contracts::bare_call(ALICE, BOB, 0, GAS_LIMIT, vec![0; 33])
                .0
                .unwrap();
            assert_return_code!(result, RuntimeReturnCode::BelowSubsistenceThreshold);
