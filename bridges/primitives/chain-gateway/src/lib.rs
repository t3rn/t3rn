...
/// Weight-to-Fee type used by Gateway.
...
pub const TO_GATEWAY_MESSAGES_DISPATCH_WEIGHT_METHOD: &str =
    "ToGatewayOutboundLaneApi_messages_dispatch_weight";
/// Name of the `ToGatewayOutboundLaneApi::latest_generated_nonce` runtime method.
pub const TO_GATEWAY_LATEST_GENERATED_NONCE_METHOD: &str =
    "ToGatewayOutboundLaneApi_latest_generated_nonce";
/// Name of the `ToGatewayOutboundLaneApi::latest_received_nonce` runtime method.
pub const TO_GATEWAY_LATEST_RECEIVED_NONCE_METHOD: &str =
    "ToGatewayOutboundLaneApi_latest_received_nonce";

/// Name of the `FromGatewayInboundLaneApi::latest_received_nonce` runtime method.
pub const FROM_GATEWAY_LATEST_RECEIVED_NONCE_METHOD: &str =
    "FromGatewayInboundLaneApi_latest_received_nonce";
/// Name of the `FromGatewayInboundLaneApi::latest_onfirmed_nonce` runtime method.
pub const FROM_GATEWAY_LATEST_CONFIRMED_NONCE_METHOD: &str =
    "FromGatewayInboundLaneApi_latest_confirmed_nonce";
/// Name of the `FromGatewayInboundLaneApi::unrewarded_relayers_state` runtime method.
pub const FROM_GATEWAY_UNREWARDED_RELAYERS_STATE: &str =
    "FromGatewayInboundLaneApi_unrewarded_relayers_state";
