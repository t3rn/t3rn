...
pub fn prepare_contract<T: Config>(
    ...
    do_preparation::<super::runtime::Env, T>(original_code, schedule, run_mode, target_id)
}
...
pub fn _reinstrument_contract<T: Config>(
    original_code: Vec<u8>,
    schedule: &Schedule<T>,
    ...
    macro_rules! prepare_test {
		($name:ident, $wat:expr, $($expected:tt)*) => {
			...
			fn $name() {
				...
				let r = do_preparation::<env::Test, crate::tests::Test>(wasm, &schedule, crate::wasm::RunMode::Post);
