...
pub struct SFXDescriptor {
    pub id: [u8; 4],
    pub arguments_abi: PerVendorAbiDescriptor,
    pub optimistic_confirmation: PerVendorAbiDescriptor,
    pub escrow_execute_confirmation: PerVendorAbiDescriptor,
    pub commit_confirmation: PerVendorAbiDescriptor,
    pub revert_confirmation: PerVendorAbiDescriptor,
}

#[derive(Clone, Encode, Decode, Eq, PartialEq, Debug, TypeInfo, Default)]
#[cfg_attr(feature = "std", derive(serde::Serialize, serde::Deserialize))]
pub enum PerVendorAbiDescriptor {
    Substrate(AbiFieldDescriptor),
    EVM(AbiFieldDescriptor),
}

#[derive(Encode, Decode, Clone, PartialEq, Eq, Debug)]
pub enum AbiFieldDescriptor {
    Struct(Vec<Box<AbiFieldDescriptor>>),
    Option(Box<AbiFieldDescriptor>),
    Bytes,
    Account,
    Account20,
    Account32,
    ...
    Byte,
    Bool,
    Vec(Box<AbiFieldDescriptor>),
    Tuple((Box<AbiFieldDescriptor>, Box<AbiFieldDescriptor>)),
}
