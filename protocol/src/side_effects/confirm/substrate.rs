        ...
        match name {
            "transfer:dirty" => {
                ...
                match Decode::decode(&mut &event_encoded[..]) {
                    ...
                    Ok(pallet_balances::Event::<T>::Withdraw { .. }) => Err("Event decodes to pallet_balances::Event::Withdraw, which is unsupported"),
                    Ok(pallet_balances::Event::<T>::Slashed { .. }) => Err("Event decodes to pallet_balances::Event::Slashed, which is unsupported"),
                    Ok(pallet_balances::Event::<T>::Reserved { .. }) => Err("Event decodes to pallet_balances::Event::Reserved, which is unsupported"),
                    Ok(pallet_balances::Event::<T>::Unreserved { .. }) => Err("Event decodes to pallet_balances::Event::Unreserved, which is unsupported"),
                    Ok(pallet_balances::Event::<T>::BalanceSet { .. }) => Err("Event decodes to pallet_balances::Event::BalanceSet, which is unsupported"),
                    Ok(pallet_balances::Event::<T>::__Ignore { .. }) => Err("Event decodes to pallet_balances::Event::BalanceSet, which is unsupported"),
                    Ok(pallet_balances::Event::<T>::ReserveRepatriated { .. }) => Err("Event decodes to pallet_balances::Event::ReserveRepatriated, which is unsupported"),
