...
export const LODESTAR_ENDPOINT = 'https://lodestar-sepolia.chainsafe.io'
...
export const EXECUTION_ENDPOINT = 'https://rpc.ankr.com/eth_sepolia'
export const BEACON_ENDPOINT = 'http://0.0.0.0:5052'
