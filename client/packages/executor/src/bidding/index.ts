...
export class BiddingEngine {
    ...
    /** Computes the bidding amount for a given SFX.
     *  Currently, this is implemented in the simplest way possible, by using the minProfitAmount and maxProfitAmount.
     *  In the future, we might want to use a more sophisticated bidding strategy.
