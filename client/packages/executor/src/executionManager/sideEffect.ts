...
import { SecurityLevel, SfxStatus, SfxType } from "@t3rn/sdk/dist/side-effects/types"
...
export class SideEffect extends EventEmitter {
    ...
    toJSON(): SerializableSideEffect {
        return {
            id: this.id,
            xtxId: this.xtxId,
            sideEffect: Object.assign({}, this.raw, { action: this.raw.action.toHuman() }),
            misc: {
    ...
    static fromJSON(o: SerializableSideEffect): SideEffect {
        ...
        sideEffect = new Gateway(o.misc.xdns).createSfx[o.sideEffect.action](sideEffect) as T3rnTypesSideEffect
