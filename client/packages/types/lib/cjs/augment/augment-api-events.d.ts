...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        accountManager: {
            ContractsRegistryExecutionFinalized: AugmentedEvent<ApiType, [executionId: u64], {
                executionId: u64;
            }>;
            DepositReceived: AugmentedEvent<ApiType, [chargeId: H256, payee: AccountId32, recipient: Option<AccountId32>, amount: u128], {
                chargeId: H256;
                payee: AccountId32;
                recipient: Option<AccountId32>;
                amount: u128;
            }>;
            Issued: AugmentedEvent<ApiType, [recipient: AccountId32, amount: u128], {
        ...
        clock: {
            NewRound: AugmentedEvent<ApiType, [index: u32, head: u32, term: u32], {
                index: u32;
                head: u32;
                term: u32;
            }>;
