...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        circuit: {
             ...
             **/
            confirmSideEffect: AugmentedSubmittable<(sfxId: H256 | string | Uint8Array, confirmation: T3rnTypesSfxConfirmedSideEffect | {
                err?: any;
                output?: any;
                inclusionData?: any;
                executioner?: any;
                receivedAt?: any;
                cost?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, T3rnTypesSfxConfirmedSideEffect]>;
            onExtrinsicTrigger: AugmentedSubmittable<(sideEffects: Vec<T3rnTypesSfxSideEffect> | (T3rnTypesSfxSideEffect | {
                target?: any;
                maxReward?: any;
                insurance?: any;
                encodedAction?: any;
                ...
                enforceExecutor?: any;
                rewardAssetId?: any;
            } | string | Uint8Array)[], sequential: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<T3rnTypesSfxSideEffect>, bool]>;
            /**
        ...
        contractsRegistry: {
             ...
             **/
            addNewContract: AugmentedSubmittable<(requester: AccountId32 | string | Uint8Array, contract: T3rnPrimitivesContractsRegistryRegistryContract | {
                codeTxt?: any;
                bytes?: any;
                author?: any;
                abi?: any;
                ...
                info?: any;
                meta?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, T3rnPrimitivesContractsRegistryRegistryContract]>;
            /**
        ...
        portal: {
            registerGateway: AugmentedSubmittable<(url: Bytes | string | Uint8Array, gatewayId: U8aFixed | string | Uint8Array, gatewayAbi: T3rnTypesAbiGatewayABIConfig | {
                ...
                decimals?: any;
                structs?: any;
            } | string | Uint8Array, gatewayVendor: T3rnPrimitivesGatewayVendor | 'Polkadot' | 'Kusama' | 'Rococo' | 'Ethereum' | number | Uint8Array, gatewayType: T3rnPrimitivesGatewayType | {
                ...
                OnCircuit: any;
            } | string | Uint8Array, gatewayGenesis: T3rnPrimitivesGatewayGenesisConfig | {
                modulesEncoded?: any;
        ...
        utility: {
             ...
             * # </weight>
             **/
            dispatchAs: AugmentedSubmittable<(asOrigin: CircuitStandaloneRuntimeOriginCaller | {
                system: any;
            } | {
                Void: any;
            } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CircuitStandaloneRuntimeOriginCaller, Call]>;
            /**
             * Send a batch of dispatch calls.
        ...
        xdns: {
            addSideEffect: AugmentedSubmittable<(id: U8aFixed | string | Uint8Array, name: Bytes | string | Uint8Array, argumentAbi: Vec<T3rnTypesAbiType> | (T3rnTypesAbiType | {
                Address: any;
            } | {
                DynamicAddress: any;
            } | {
                ...
                Crypto: any;
            } | string | Uint8Array)[], argumentToStateMapper: Vec<Bytes> | (Bytes | string | Uint8Array)[], confirmEvents: Vec<Bytes> | (Bytes | string | Uint8Array)[], escrowedEvents: Vec<Bytes> | (Bytes | string | Uint8Array)[], commitEvents: Vec<Bytes> | (Bytes | string | Uint8Array)[], revertEvents: Vec<Bytes> | (Bytes | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [U8aFixed, Bytes, Vec<T3rnTypesAbiType>, Vec<Bytes>, Vec<Bytes>, Vec<Bytes>, Vec<Bytes>, Vec<Bytes>]>;
            /**
