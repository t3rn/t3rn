...
import type { CodeSource, CodeUploadResult, ContractExecResultU64, ContractInstantiateResultU64 } from '@polkadot/types/interfaces/contracts';
...
declare module '@polkadot/api-base/types/calls' {
  interface AugmentedCalls<ApiType extends ApiTypes> {
    ...
    contractsApi: {
       ...
       **/
      call: AugmentedCall<ApiType, (origin: AccountId | string | Uint8Array, dest: AccountId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array, storageDepositLimit: Option<Balance> | null | Uint8Array | Balance | AnyNumber, inputData: Bytes | string | Uint8Array) => Observable<ContractExecResultU64>>;
      /**
