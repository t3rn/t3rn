...
export class Connection {
	...
	constructor(rpc1: any, rpc2: any, isCircuit: boolean, prometheus: Prometheus, target: string, substratePrivateKey: string) {
		this.rpc1 = rpc1
		this.rpc2 = rpc2
	...
	async connect() {
		...
		while(true) {
			try {
				...
				this.prometheus.circuitDisconnectsTotal.inc({target: this.target})
