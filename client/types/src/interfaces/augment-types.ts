...
import type { GatewayOutboundEvent, GatewayOutboundEventId, ProofType, StepConfirmation, Xtx, XtxId, XtxSchedule, result_status } from 't3rn-circuit-typegen/interfaces/execution_delivery';
