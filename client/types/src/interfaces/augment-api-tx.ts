...
import type { ConfirmedSideEffect, GatewayABIConfig, GatewayGenesisConfig, GatewayType, GatewayVendor, SideEffect } from 't3rn-circuit-typegen/interfaces/primitives';
