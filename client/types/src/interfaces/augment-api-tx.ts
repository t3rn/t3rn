...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    contractsRegistry: {
       ...
       **/
      addNewContract: AugmentedSubmittable<(requester: AccountId | string | Uint8Array, contract: RegistryContract | { code_txt?: any; bytes?: any; author?: any; author_fees_per_single_use?: any; abi?: any; action_descriptions?: any; info?: any; meta?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, RegistryContract]>;
      /**
       * Removes a contract from the onchain registry. Root only access.
       **/
      purge: AugmentedSubmittable<(requester: AccountId | string | Uint8Array, contractId: RegistryContractId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, RegistryContractId]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    execDelivery: {
      ...
      updateGateway: AugmentedSubmittable<(gatewayId: ChainId | string | Uint8Array, url: Option<Bytes> | null | object | string | Uint8Array, gatewayAbi: Option<GatewayABIConfig> | null | object | string | Uint8Array, gatewaySysProps: Option<GatewaySysProps> | null | object | string | Uint8Array, authorities: Option<Vec<AccountId>> | null | object | string | Uint8Array, allowedSideEffects: Option<Vec<AllowedSideEffect>> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ChainId, Option<Bytes>, Option<GatewayABIConfig>, Option<GatewaySysProps>, Option<Vec<AccountId>>, Option<Vec<AllowedSideEffect>>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    xdns: {
       ...
       **/
      addNewXdnsRecord: AugmentedSubmittable<(url: Bytes | string | Uint8Array, gatewayId: ChainId | string | Uint8Array, gatewayAbi: GatewayABIConfig | { block_number_type_size?: any; hash_size?: any; hasher?: any; crypto?: any; address_length?: any; value_type_size?: any; decimals?: any; structs?: any } | string | Uint8Array, gatewayVendor: GatewayVendor | 'Substrate' | 'Ethereum' | number | Uint8Array, gatewayType: GatewayType | { ProgrammableInternal: any } | { ProgrammableExternal: any } | { TxOnly: any } | string | Uint8Array, gatewayGenesis: GatewayGenesisConfig | { modules_encoded?: any; runtime_version?: any; extrinsics_version?: any; genesis_hash?: any } | string | Uint8Array, gatewaySysProps: GatewaySysProps | { ss58_format?: any; token_symbol?: any; token_decimals?: any } | string | Uint8Array, allowedSideEffects: Vec<AllowedSideEffect> | (AllowedSideEffect | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Bytes, ChainId, GatewayABIConfig, GatewayVendor, GatewayType, GatewayGenesisConfig, GatewaySysProps, Vec<AllowedSideEffect>]>;
      /**
