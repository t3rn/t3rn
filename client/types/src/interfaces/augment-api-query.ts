  ...
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    circuit: {
      ...
      fullSideEffects: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<Vec<Vec<T3rnPrimitivesSideEffectFullSideEffect>>>>,
        [H256]
      > &
      ...
      localXtxStates: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<T3rnPrimitivesVolatileLocalState>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      ...
      xExecSignals: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<PalletCircuitStateXExecSignal>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      /** Current Circuit's context of active full side effects (requested + confirmation proofs) */
      xtxInsuranceLinks: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Vec<H256>>, [H256]> &
        QueryableStorageEntry<ApiType, [H256]>;
      /** Generic query */
      [key: string]: QueryableStorageEntry<ApiType>;
    };
    ...
    contractsRegistry: {
      ...
      contractsRegistry: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<PalletContractsRegistryRegistryContract>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      /** Generic query */
    ...
    grandpa: {
       ...
       */
      setIdSession: AugmentedQuery<ApiType, (arg: u64) => Observable<Option<u32>>, [u64]> &
    ...
    multiFinalityVerifierEthereumLike: {
      ...
      currentAuthoritySetMap: AugmentedQuery<
        ApiType,
        (arg: U8aFixed | string | Uint8Array) => Observable<Option<T3rnPrimitivesBridgesHeaderChainAuthoritySet>>,
        [U8aFixed]
      > &
        QueryableStorageEntry<ApiType, [U8aFixed]>;
      ...
      multiImportedHashes: AugmentedQuery<
        ApiType,
        (arg1: U8aFixed | string | Uint8Array, arg2: u32) => Observable<Option<H256>>,
        [U8aFixed, u32]
      > &
       ...
       *
       * Pallet owner has a right to halt all pallet operations and then resume it. If it is `None`, then there are no
       * direct ways to halt/resume pallet operations, but other runtime methods may still be used to do that (i.e.
      ...
      palletOwnerMap: AugmentedQuery<
        ApiType,
        (arg: U8aFixed | string | Uint8Array) => Observable<Option<AccountId32>>,
        [U8aFixed]
      > &
        QueryableStorageEntry<ApiType, [U8aFixed]>;
      /**
       ...
       *
       * If the `RequestCount` hits `MaxRequests`, no more calls will be allowed to the pallet until the request
       * capacity is increased.
       *
       * The `RequestCount` is decreased by one at the beginning of every block. This is to ensure that the pallet can
    ...
    ormlTokens: {
      ...
      accounts: AugmentedQuery<
        ApiType,
        (arg1: AccountId32 | string | Uint8Array, arg2: u32) => Observable<OrmlTokensAccountData>,
        [AccountId32, u32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, u32]>;
      /**
       * Any liquidity locks of a token type under an account. NOTE: Should only be accessed when setting, changing and
       * freeing a lock.
       */
      locks: AugmentedQuery<
        ApiType,
        (arg1: AccountId32 | string | Uint8Array, arg2: u32) => Observable<Vec<OrmlTokensBalanceLock>>,
        [AccountId32, u32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, u32]>;
      /** The total issuance of a token type. */
      totalIssuance: AugmentedQuery<ApiType, (arg: u32) => Observable<u128>, [u32]> &
    ...
    randomnessCollectiveFlip: {
      /**
       * Series of block headers from the last 81 blocks that acts as random seed material. This is arranged as a ring
       * buffer with `block_number % 81` being the index into the `Vec` of the oldest hash.
       */
    ...
    system: {
      ...
      extrinsicData: AugmentedQuery<ApiType, (arg: u32) => Observable<Bytes>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
    ...
    xdns: {
      customSideEffects: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<PalletXdnsSideEffectInterface>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      standardSideEffects: AugmentedQuery<
        ApiType,
        (arg: U8aFixed | string | Uint8Array) => Observable<Option<PalletXdnsSideEffectInterface>>,
        [U8aFixed]
      > &
        QueryableStorageEntry<ApiType, [U8aFixed]>;
      ...
      xdnsRegistry: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<PalletXdnsXdnsRecord>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      /** Generic query */
