...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  export interface RpcInterface {
    ...
    contracts: {
      ...
      call: AugmentedRpc<
        (callRequest: ContractCallRequest, at?: BlockHash | string | Uint8Array) => Observable<ContractExecResult>
      >;
      ...
      instantiate: AugmentedRpc<
        (request: InstantiateRequest, at?: BlockHash | string | Uint8Array) => Observable<ContractInstantiateResult>
      >;
    ...
    engine: {
      ...
      createBlock: AugmentedRpc<
        (createEmpty: bool, finalize: bool, parentHash?: BlockHash | string | Uint8Array) => Observable<CreatedBlock>
      >;
    ...
    eth: {
      ...
      getProof: AugmentedRpc<
        (address: H160 | string | Uint8Array, storageKeys: Vec<H256>, number: BlockNumber) => Observable<EthAccount>
      >;
      /** Returns content of the storage at given address. */
      getStorageAt: AugmentedRpc<
        (address: H160 | string | Uint8Array, index: U256, number?: BlockNumber) => Observable<H256>
      >;
      /** Returns transaction at given block hash and index. */
      getTransactionByBlockHashAndIndex: AugmentedRpc<
        (hash: H256 | string | Uint8Array, index: U256) => Observable<EthTransaction>
      >;
      /** Returns transaction by given block number and index. */
      getTransactionByBlockNumberAndIndex: AugmentedRpc<
        (number: BlockNumber, index: U256) => Observable<EthTransaction>
      >;
      ...
      getUncleByBlockHashAndIndex: AugmentedRpc<
        (hash: H256 | string | Uint8Array, index: U256) => Observable<EthRichBlock>
      >;
      /** Returns an uncles at given block and index. */
    ...
    mmr: {
      ...
      generateProof: AugmentedRpc<(leafIndex: u64, at?: BlockHash | string | Uint8Array) => Observable<MmrLeafProof>>;
    };
    net: {
    ...
    offchain: {
      ...
      localStorageSet: AugmentedRpc<
        (kind: StorageKind, key: Bytes | string | Uint8Array, value: Bytes | string | Uint8Array) => Observable<Null>
      >;
    };
    payment: {
    ...
    state: {
      ...
      getReadProof: AugmentedRpc<
        (keys: Vec<StorageKey>, at?: BlockHash | string | Uint8Array) => Observable<ReadProof>
      >;
    ...
    system: {
      ...
      /**
       * The addresses include a trailing /p2p/ with the local PeerId, and are thus suitable to be passed to
       * addReservedPeer or as a bootnode address for example
       */
