...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    circuit: {
      CancelledSideEffects: AugmentedEvent<ApiType, [AccountId32, H256, Vec<T3rnPrimitivesSideEffect>]>;
      NewSideEffectsAvailable: AugmentedEvent<ApiType, [AccountId32, H256, Vec<T3rnPrimitivesSideEffect>]>;
      SideEffectsConfirmed: AugmentedEvent<ApiType, [H256, Vec<Vec<T3rnPrimitivesSideEffectFullSideEffect>>]>;
    ...
    circuitPortal: {
      GatewayUpdated: AugmentedEvent<ApiType, [U8aFixed, Option<Vec<U8aFixed>>]>;
