...
fn testnet_genesis(
	...
	GenesisConfig {
		frame_system: SystemConfig {
			code: WASM_BINARY.expect("Circuit development WASM not available").to_vec(),
...
fn derived_dave_account_is_as_expected() {
	...
	let derived: AccountId = derive_account_from_gateway_id(bp_runtime::SourceAccount::Account(dave));
	assert_eq!(
		derived.to_string(),
