...
pub type ToGatewayMessagePayload =
    messages::source::FromThisChainMessagePayload<WithGatewayMessageBridge>;

/// Message verifier for Circuit -> Gateway messages.
pub type ToGatewayMessageVerifier =
    messages::source::FromThisChainMessageVerifier<WithGatewayMessageBridge>;

/// Message payload for Gateway -> Circuit messages.
pub type FromGatewayMessagePayload =
    messages::target::FromBridgedChainMessagePayload<WithGatewayMessageBridge>;

/// Encoded Circuit Call as it comes from Gateway.
pub type FromGatewayEncodedCall =
    messages::target::FromBridgedChainEncodedMessageCall<WithGatewayMessageBridge>;
...
type ToGatewayMessagesDeliveryProof =
    messages::source::FromBridgedChainMessagesDeliveryProof<bp_gateway::Hash>;
...
impl MessageBridge for WithGatewayMessageBridge {
    ...
    fn bridged_balance_to_this_balance(
        bridged_balance: bp_gateway::Balance,
    ) -> bp_circuit::Balance {
...
impl MessagesParameter for CircuitToGatewayMessagesParameter {
    fn save(&self) {
        match *self {
            CircuitToGatewayMessagesParameter::GatewayToCircuitConversionRate(
                ref conversion_rate,
