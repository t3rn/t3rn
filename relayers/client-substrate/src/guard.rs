        ...
        loop {
            ...
            match current_balance {
                Ok(current_balance) => {
                    ...
                    let (oldest_time, oldest_balance) = balances
                        .front()
                        .expect("pushed to queue couple of lines above; qed");
