...
These are the default RPC providers. Executors can add their custom RPC URLs. Find out how to set them up in [Docker Setup](./become-an-executor/docker-setup.md) and [AIxecutors](./become-an-executor/aixecutor-setup.md) in our docs.
:::
